...
class DIMDataset(Dataset):
    def __init__(self, split):
        ...
        if self.split == 'train':
            self.IMG_PATH = '/home/zeyang/train_dataset/image'
        else:
            self.IMG_PATH = '/home/zeyang/face_dataset/testing/image'
    ...
    def __getitem__(self, index):
        ...
        trimap_path = img_path.replace("image","trimap")
        alpha_path = img_path.replace("image","matte")
